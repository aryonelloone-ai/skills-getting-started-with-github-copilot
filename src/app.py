...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice and meet preparation",
    ...
    "Science Fair": {
        "description": "Research projects and experiments for the science fair",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["jordan@mergington.edu", "ella@mergington.edu"]
    }
}
